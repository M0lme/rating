...
var album = {
    ...
    isDenied: function(name, artistIndex, rating, year, genreIndex) { // jos yksikin ehdoista on false, return false
        rating = getConfirmedNumber(rating);
...
var display = {
    ...
    updateSectionMiddle: function() {
        ...
        for (let g = 0; g < genre.name.length; g++) {
            ...
            let genreCondition3 = (genre.sortBy && album.getNumberOf(g, "genre") === 0); // checks if genre has at least 1 album that passes filter conditions WHEN genre.sortBy == true
